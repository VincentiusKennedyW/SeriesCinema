...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      final id = widget.id;
      context.read<DetailMovieBloc>().add(FetchDetailMovie(id));
      context
          .read<WatchlistStatusMovieBloc>()
          .add(LoadWatchlistStatusMovie(id));
      context.read<RecommendationMovieBloc>().add(FetchRecommendationMovie(id));
    });
  }
